...
public class EventoDao {
	...
	public List<EventoModel> list() {
		return em.createQuery("SELECT e FROM EventoModel e", EventoModel.class).getResultList();
	}

	public EventoModel getCodigo(Long codigo) {
		return em.createQuery("SELECT e FROM EventoModel e WHERE e.codigo = :codigo", EventoModel.class)
